...
version: 1.0.0
difficulty: advanced
tags: ["nosql","elasticsearch-query","troubleshooting","advanced"]
tools: ["claude-code","kilo","cline","opencode","cursor","windsurf"]
description: "nosql elasticsearch-query troubleshooting at advanced level"
---
# Nosql Elasticsearch Query — Advanced
