---
name: nosql-neo4j-graph-patterns
category: database/nosql
version: 1.0.0
difficulty: intermediate
tags: ["nosql","neo4j-graph","patterns","intermediate"]
tools: ["claude-code","kilo","cline","opencode","cursor","windsurf"]
description: "nosql neo4j-graph patterns at intermediate level"
---
...
This skill covers patterns patterns for neo4j-graph in nosql.
...
```
// nosql neo4j-graph patterns pattern
