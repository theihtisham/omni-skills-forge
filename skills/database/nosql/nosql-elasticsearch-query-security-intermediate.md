---
name: nosql-elasticsearch-query-security
category: database/nosql
version: 1.0.0
difficulty: intermediate
tags: ["nosql","elasticsearch-query","security","intermediate"]
tools: ["claude-code","kilo","cline","opencode","cursor","windsurf"]
description: "nosql elasticsearch-query security at intermediate level"
---
...
### Elasticsearch Query — security

This skill covers security patterns for elasticsearch-query in nosql.
...
```
// nosql elasticsearch-query security pattern
