---
name: csharp-health-checks-migration
category: backend/csharp
version: 1.0.0
difficulty: intermediate
tags: ["csharp","health-checks","migration","intermediate"]
tools: ["claude-code","kilo","cline","opencode","cursor","windsurf"]
description: "csharp health-checks migration at intermediate level"
---
...
This skill covers migration patterns for health-checks in csharp.
...
```
// csharp health-checks migration pattern
