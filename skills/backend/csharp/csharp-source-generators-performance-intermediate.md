---
name: csharp-source-generators-performance
category: backend/csharp
version: 1.0.0
difficulty: intermediate
tags: ["csharp","source-generators","performance","intermediate"]
tools: ["claude-code","kilo","cline","opencode","cursor","windsurf"]
description: "csharp source-generators performance at intermediate level"
---
...
This skill covers performance patterns for source-generators in csharp.
...
```
// csharp source-generators performance pattern
