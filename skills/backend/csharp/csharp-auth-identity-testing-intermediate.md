---
name: csharp-auth-identity-testing
category: backend/csharp
version: 1.0.0
difficulty: intermediate
tags: ["csharp","auth-identity","testing","intermediate"]
tools: ["claude-code","kilo","cline","opencode","cursor","windsurf"]
description: "csharp auth-identity testing at intermediate level"
---
...
### Auth Identity — testing

This skill covers testing patterns for auth-identity in csharp.
...
```
// csharp auth-identity testing pattern
