---
name: python-async-await-migration
category: backend/python
version: 1.0.0
difficulty: expert
tags: ["python","async-await","migration","expert"]
tools: ["claude-code","kilo","cline","opencode","cursor","windsurf"]
description: "python async-await migration at expert level"
---
...
This skill covers migration patterns for async-await in python.
...
```
// python async-await migration pattern
