...
version: 1.0.0
difficulty: expert
tags: ["python","error-handling","patterns","expert"]
tools: ["claude-code","kilo","cline","opencode","cursor","windsurf"]
description: "python error-handling patterns at expert level"
---
...
This skill covers patterns patterns for error-handling in python.
...
```
// python error-handling patterns pattern
