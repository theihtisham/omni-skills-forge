...
version: 1.0.0
difficulty: expert
tags: ["python","fastapi-production","architecture","expert"]
tools: ["claude-code","kilo","cline","opencode","cursor","windsurf"]
description: "python fastapi-production architecture at expert level"
---
...
This skill covers architecture patterns for fastapi-production in python.
...
```
// python fastapi-production architecture pattern
