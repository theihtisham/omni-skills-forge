...
version: 1.0.0
difficulty: advanced
tags: ["nodejs","docker-deployment","troubleshooting","advanced"]
tools: ["claude-code","kilo","cline","opencode","cursor","windsurf"]
description: "nodejs docker-deployment troubleshooting at advanced level"
---
# Nodejs Docker Deployment — Advanced
