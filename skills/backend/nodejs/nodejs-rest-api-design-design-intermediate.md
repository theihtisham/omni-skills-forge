---
name: nodejs-rest-api-design-design
category: backend/nodejs
version: 1.0.0
difficulty: intermediate
tags: ["nodejs","rest-api-design","design","intermediate"]
tools: ["claude-code","kilo","cline","opencode","cursor","windsurf"]
description: "nodejs rest-api-design design at intermediate level"
---
...
### Rest Api Design — design

This skill covers design patterns for rest-api-design in nodejs.
...
```
// nodejs rest-api-design design pattern
