---
name: kubernetes-custom-resources-monitoring
category: devops/kubernetes
version: 1.0.0
difficulty: intermediate
tags: ["kubernetes","custom-resources","monitoring","intermediate"]
tools: ["claude-code","kilo","cline","opencode","cursor","windsurf"]
description: "kubernetes custom-resources monitoring at intermediate level"
---
...
This skill covers monitoring patterns for custom-resources in kubernetes.
...
```
// kubernetes custom-resources monitoring pattern
