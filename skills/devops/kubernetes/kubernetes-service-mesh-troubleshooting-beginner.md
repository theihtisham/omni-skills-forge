...
version: 1.0.0
difficulty: beginner
tags: ["kubernetes","service-mesh","troubleshooting","beginner"]
tools: ["claude-code","kilo","cline","opencode","cursor","windsurf"]
description: "kubernetes service-mesh troubleshooting at beginner level"
---
# Kubernetes Service Mesh — Beginner
