...
version: 1.0.0
difficulty: beginner
tags: ["kubernetes","custom-resources","troubleshooting","beginner"]
tools: ["claude-code","kilo","cline","opencode","cursor","windsurf"]
description: "kubernetes custom-resources troubleshooting at beginner level"
---
# Kubernetes Custom Resources — Beginner
