---
name: kubernetes-helm-charts-deployment
category: devops/kubernetes
version: 1.0.0
difficulty: intermediate
tags: ["kubernetes","helm-charts","deployment","intermediate"]
tools: ["claude-code","kilo","cline","opencode","cursor","windsurf"]
description: "kubernetes helm-charts deployment at intermediate level"
---
...
This skill covers deployment patterns for helm-charts in kubernetes.
...
```
// kubernetes helm-charts deployment pattern
