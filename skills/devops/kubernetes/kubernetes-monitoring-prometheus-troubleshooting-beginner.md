...
version: 1.0.0
difficulty: beginner
tags: ["kubernetes","monitoring-prometheus","troubleshooting","beginner"]
tools: ["claude-code","kilo","cline","opencode","cursor","windsurf"]
description: "kubernetes monitoring-prometheus troubleshooting at beginner level"
---
# Kubernetes Monitoring Prometheus — Beginner
