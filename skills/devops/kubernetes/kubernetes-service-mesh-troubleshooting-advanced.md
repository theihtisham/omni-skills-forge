...
version: 1.0.0
difficulty: advanced
tags: ["kubernetes","service-mesh","troubleshooting","advanced"]
tools: ["claude-code","kilo","cline","opencode","cursor","windsurf"]
description: "kubernetes service-mesh troubleshooting at advanced level"
---
# Kubernetes Service Mesh — Advanced
