...
version: 1.0.0
difficulty: advanced
tags: ["kubernetes","config-management","scalability","advanced"]
tools: ["claude-code","kilo","cline","opencode","cursor","windsurf"]
description: "kubernetes config-management scalability at advanced level"
---
# Kubernetes Config Management — Advanced
