...
tags: ["kubernetes","multi-cluster","troubleshooting","intermediate"]
tools: ["claude-code","kilo","cline","opencode","cursor","windsurf"]
description: "kubernetes multi-cluster troubleshooting at intermediate level"
---
# Kubernetes Multi Cluster — Intermediate
