...
version: 1.0.0
difficulty: advanced
tags: ["kubernetes","disaster-recovery-k8s","troubleshooting","advanced"]
tools: ["claude-code","kilo","cline","opencode","cursor","windsurf"]
description: "kubernetes disaster-recovery-k8s troubleshooting at advanced level"
---
# Kubernetes Disaster Recovery K8s — Advanced
