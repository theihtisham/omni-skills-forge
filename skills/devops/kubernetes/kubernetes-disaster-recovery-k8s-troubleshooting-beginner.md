...
version: 1.0.0
difficulty: beginner
tags: ["kubernetes","disaster-recovery-k8s","troubleshooting","beginner"]
tools: ["claude-code","kilo","cline","opencode","cursor","windsurf"]
description: "kubernetes disaster-recovery-k8s troubleshooting at beginner level"
---
# Kubernetes Disaster Recovery K8s — Beginner
