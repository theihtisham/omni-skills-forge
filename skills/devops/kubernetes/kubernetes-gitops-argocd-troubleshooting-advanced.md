...
version: 1.0.0
difficulty: advanced
tags: ["kubernetes","gitops-argocd","troubleshooting","advanced"]
tools: ["claude-code","kilo","cline","opencode","cursor","windsurf"]
description: "kubernetes gitops-argocd troubleshooting at advanced level"
---
# Kubernetes Gitops Argocd — Advanced
