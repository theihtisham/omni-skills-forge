...
version: 1.0.0
difficulty: beginner
tags: ["kubernetes","logging-efk","troubleshooting","beginner"]
tools: ["claude-code","kilo","cline","opencode","cursor","windsurf"]
description: "kubernetes logging-efk troubleshooting at beginner level"
---
# Kubernetes Logging Efk — Beginner
