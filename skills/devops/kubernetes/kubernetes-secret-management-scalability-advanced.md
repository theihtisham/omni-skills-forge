...
version: 1.0.0
difficulty: advanced
tags: ["kubernetes","secret-management","scalability","advanced"]
tools: ["claude-code","kilo","cline","opencode","cursor","windsurf"]
description: "kubernetes secret-management scalability at advanced level"
---
# Kubernetes Secret Management — Advanced
