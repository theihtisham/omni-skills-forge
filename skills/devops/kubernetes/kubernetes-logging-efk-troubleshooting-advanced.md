...
version: 1.0.0
difficulty: advanced
tags: ["kubernetes","logging-efk","troubleshooting","advanced"]
tools: ["claude-code","kilo","cline","opencode","cursor","windsurf"]
description: "kubernetes logging-efk troubleshooting at advanced level"
---
# Kubernetes Logging Efk — Advanced
