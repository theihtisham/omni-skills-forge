...
version: 1.0.0
difficulty: beginner
tags: ["kubernetes","multi-cluster","troubleshooting","beginner"]
tools: ["claude-code","kilo","cline","opencode","cursor","windsurf"]
description: "kubernetes multi-cluster troubleshooting at beginner level"
---
# Kubernetes Multi Cluster — Beginner
