...
version: 1.0.0
difficulty: expert
tags: ["kubernetes","multi-cluster","architecture","expert"]
tools: ["claude-code","kilo","cline","opencode","cursor","windsurf"]
description: "kubernetes multi-cluster architecture at expert level"
---
...
This skill covers architecture patterns for multi-cluster in kubernetes.
...
```
// kubernetes multi-cluster architecture pattern
