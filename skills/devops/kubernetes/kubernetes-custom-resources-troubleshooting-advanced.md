...
version: 1.0.0
difficulty: advanced
tags: ["kubernetes","custom-resources","troubleshooting","advanced"]
tools: ["claude-code","kilo","cline","opencode","cursor","windsurf"]
description: "kubernetes custom-resources troubleshooting at advanced level"
---
# Kubernetes Custom Resources — Advanced
