...
version: 1.0.0
difficulty: advanced
tags: ["kubernetes","monitoring-prometheus","troubleshooting","advanced"]
tools: ["claude-code","kilo","cline","opencode","cursor","windsurf"]
description: "kubernetes monitoring-prometheus troubleshooting at advanced level"
---
# Kubernetes Monitoring Prometheus — Advanced
