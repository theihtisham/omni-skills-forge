---
name: kubernetes-storage-pv-scalability
category: devops/kubernetes
version: 1.0.0
difficulty: intermediate
tags: ["kubernetes","storage-pv","scalability","intermediate"]
tools: ["claude-code","kilo","cline","opencode","cursor","windsurf"]
description: "kubernetes storage-pv scalability at intermediate level"
---
...
### Storage Pv — scalability

This skill covers scalability patterns for storage-pv in kubernetes.
...
```
// kubernetes storage-pv scalability pattern
