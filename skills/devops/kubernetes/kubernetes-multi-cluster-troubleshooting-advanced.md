...
version: 1.0.0
difficulty: advanced
tags: ["kubernetes","multi-cluster","troubleshooting","advanced"]
tools: ["claude-code","kilo","cline","opencode","cursor","windsurf"]
description: "kubernetes multi-cluster troubleshooting at advanced level"
---
# Kubernetes Multi Cluster — Advanced
