---
name: kubernetes-troubleshooting-design
category: devops/kubernetes
version: 1.0.0
difficulty: expert
tags: ["kubernetes","troubleshooting","design","expert"]
tools: ["claude-code","kilo","cline","opencode","cursor","windsurf"]
description: "kubernetes troubleshooting design at expert level"
---
...
This skill covers design patterns for troubleshooting in kubernetes.
...
```
// kubernetes troubleshooting design pattern
