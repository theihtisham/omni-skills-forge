---
name: kubernetes-admission-controllers-hardening
category: devops/kubernetes
version: 1.0.0
difficulty: beginner
tags: ["kubernetes","admission-controllers","hardening","beginner"]
tools: ["claude-code","kilo","cline","opencode","cursor","windsurf"]
description: "kubernetes admission-controllers hardening at beginner level"
---
...
### Admission Controllers — hardening

This skill covers hardening patterns for admission-controllers in kubernetes.
...
```
// kubernetes admission-controllers hardening pattern
