...
version: 1.0.0
difficulty: advanced
tags: ["docker","compose-production","troubleshooting","advanced"]
tools: ["claude-code","kilo","cline","opencode","cursor","windsurf"]
description: "docker compose-production troubleshooting at advanced level"
---
# Docker Compose Production — Advanced
