...
version: 1.0.0
difficulty: advanced
tags: ["docker","monitoring-docker","troubleshooting","advanced"]
tools: ["claude-code","kilo","cline","opencode","cursor","windsurf"]
description: "docker monitoring-docker troubleshooting at advanced level"
---
# Docker Monitoring Docker — Advanced
