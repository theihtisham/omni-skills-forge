...
tags: ["docker","compose-production","troubleshooting","intermediate"]
tools: ["claude-code","kilo","cline","opencode","cursor","windsurf"]
description: "docker compose-production troubleshooting at intermediate level"
---
# Docker Compose Production — Intermediate
