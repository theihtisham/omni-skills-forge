...
version: 1.0.0
difficulty: beginner
tags: ["docker","monitoring-docker","troubleshooting","beginner"]
tools: ["claude-code","kilo","cline","opencode","cursor","windsurf"]
description: "docker monitoring-docker troubleshooting at beginner level"
---
# Docker Monitoring Docker — Beginner
