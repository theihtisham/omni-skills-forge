---
name: docker-windows-containers-production
category: devops/docker
version: 1.0.0
difficulty: intermediate
tags: ["docker","windows-containers","production","intermediate"]
tools: ["claude-code","kilo","cline","opencode","cursor","windsurf"]
description: "docker windows-containers production at intermediate level"
---
...
### Windows Containers — production

This skill covers production patterns for windows-containers in docker.
...
```
// docker windows-containers production pattern
