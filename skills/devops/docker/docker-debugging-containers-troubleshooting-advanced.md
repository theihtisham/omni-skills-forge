...
version: 1.0.0
difficulty: advanced
tags: ["docker","debugging-containers","troubleshooting","advanced"]
tools: ["claude-code","kilo","cline","opencode","cursor","windsurf"]
description: "docker debugging-containers troubleshooting at advanced level"
---
# Docker Debugging Containers — Advanced
