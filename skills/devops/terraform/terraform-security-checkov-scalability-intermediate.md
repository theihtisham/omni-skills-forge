---
name: terraform-security-checkov-scalability
category: devops/terraform
version: 1.0.0
difficulty: intermediate
tags: ["terraform","security-checkov","scalability","intermediate"]
tools: ["claude-code","kilo","cline","opencode","cursor","windsurf"]
description: "terraform security-checkov scalability at intermediate level"
---
...
### Security Checkov — scalability

This skill covers scalability patterns for security-checkov in terraform.
...
```
// terraform security-checkov scalability pattern
