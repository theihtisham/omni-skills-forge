...
version: 1.0.0
difficulty: advanced
tags: ["terraform","drift-detection","troubleshooting","advanced"]
tools: ["claude-code","kilo","cline","opencode","cursor","windsurf"]
description: "terraform drift-detection troubleshooting at advanced level"
---
# Terraform Drift Detection — Advanced
