...
version: 1.0.0
difficulty: beginner
tags: ["terraform","migration-refactoring","troubleshooting","beginner"]
tools: ["claude-code","kilo","cline","opencode","cursor","windsurf"]
description: "terraform migration-refactoring troubleshooting at beginner level"
---
# Terraform Migration Refactoring — Beginner
