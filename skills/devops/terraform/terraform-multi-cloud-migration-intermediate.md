---
name: terraform-multi-cloud-migration
category: devops/terraform
version: 1.0.0
difficulty: intermediate
tags: ["terraform","multi-cloud","migration","intermediate"]
tools: ["claude-code","kilo","cline","opencode","cursor","windsurf"]
description: "terraform multi-cloud migration at intermediate level"
---
...
This skill covers migration patterns for multi-cloud in terraform.
...
```
// terraform multi-cloud migration pattern
