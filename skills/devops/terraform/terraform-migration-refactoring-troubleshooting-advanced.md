...
version: 1.0.0
difficulty: advanced
tags: ["terraform","migration-refactoring","troubleshooting","advanced"]
tools: ["claude-code","kilo","cline","opencode","cursor","windsurf"]
description: "terraform migration-refactoring troubleshooting at advanced level"
---
# Terraform Migration Refactoring — Advanced
