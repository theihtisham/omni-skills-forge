...
version: 1.0.0
difficulty: beginner
tags: ["terraform","drift-detection","troubleshooting","beginner"]
tools: ["claude-code","kilo","cline","opencode","cursor","windsurf"]
description: "terraform drift-detection troubleshooting at beginner level"
---
# Terraform Drift Detection — Beginner
