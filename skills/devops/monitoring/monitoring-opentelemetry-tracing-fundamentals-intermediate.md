---
name: monitoring-opentelemetry-tracing-fundamentals
category: devops/monitoring
version: 1.0.0
difficulty: intermediate
tags: ["monitoring","opentelemetry-tracing","fundamentals","intermediate"]
tools: ["claude-code","kilo","cline","opencode","cursor","windsurf"]
description: "monitoring opentelemetry-tracing fundamentals at intermediate level"
---
...
This skill covers fundamentals patterns for opentelemetry-tracing in monitoring.
...
```
// monitoring opentelemetry-tracing fundamentals pattern
