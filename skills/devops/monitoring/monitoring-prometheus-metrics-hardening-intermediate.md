---
name: monitoring-prometheus-metrics-hardening
category: devops/monitoring
version: 1.0.0
difficulty: intermediate
tags: ["monitoring","prometheus-metrics","hardening","intermediate"]
tools: ["claude-code","kilo","cline","opencode","cursor","windsurf"]
description: "monitoring prometheus-metrics hardening at intermediate level"
---
...
This skill covers hardening patterns for prometheus-metrics in monitoring.
...
```
// monitoring prometheus-metrics hardening pattern
