...
tags: ["monitoring","log-aggregation","troubleshooting","intermediate"]
tools: ["claude-code","kilo","cline","opencode","cursor","windsurf"]
description: "monitoring log-aggregation troubleshooting at intermediate level"
---
# Monitoring Log Aggregation — Intermediate
