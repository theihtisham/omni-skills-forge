---
name: monitoring-opentelemetry-tracing-advanced
category: devops/monitoring
version: 1.0.0
difficulty: intermediate
tags: ["monitoring","opentelemetry-tracing","advanced","intermediate"]
tools: ["claude-code","kilo","cline","opencode","cursor","windsurf"]
description: "monitoring opentelemetry-tracing advanced at intermediate level"
---
...
### Opentelemetry Tracing — advanced

This skill covers advanced patterns for opentelemetry-tracing in monitoring.
...
```
// monitoring opentelemetry-tracing advanced pattern
