...
version: 1.0.0
difficulty: beginner
tags: ["monitoring","load-testing","troubleshooting","beginner"]
tools: ["claude-code","kilo","cline","opencode","cursor","windsurf"]
description: "monitoring load-testing troubleshooting at beginner level"
---
# Monitoring Load Testing — Beginner
