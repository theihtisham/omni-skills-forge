...
version: 1.0.0
difficulty: beginner
tags: ["monitoring","alerting-rules","troubleshooting","beginner"]
tools: ["claude-code","kilo","cline","opencode","cursor","windsurf"]
description: "monitoring alerting-rules troubleshooting at beginner level"
---
# Monitoring Alerting Rules — Beginner
