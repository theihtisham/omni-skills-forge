...
version: 1.0.0
difficulty: advanced
tags: ["monitoring","prometheus-metrics","scalability","advanced"]
tools: ["claude-code","kilo","cline","opencode","cursor","windsurf"]
description: "monitoring prometheus-metrics scalability at advanced level"
---
# Monitoring Prometheus Metrics — Advanced
