---
name: cicd-gitlab-ci-performance
category: devops/cicd
version: 1.0.0
difficulty: intermediate
tags: ["cicd","gitlab-ci","performance","intermediate"]
tools: ["claude-code","kilo","cline","opencode","cursor","windsurf"]
description: "cicd gitlab-ci performance at intermediate level"
---
...
This skill covers performance patterns for gitlab-ci in cicd.
...
```
// cicd gitlab-ci performance pattern
