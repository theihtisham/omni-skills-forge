...
version: 1.0.0
difficulty: advanced
tags: ["rag","query-transformation","troubleshooting","advanced"]
tools: ["claude-code","kilo","cline","opencode","cursor","windsurf"]
description: "rag query-transformation troubleshooting at advanced level"
---
# Rag Query Transformation — Advanced
