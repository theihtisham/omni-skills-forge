...
version: 1.0.0
difficulty: beginner
tags: ["rag","query-transformation","troubleshooting","beginner"]
tools: ["claude-code","kilo","cline","opencode","cursor","windsurf"]
description: "rag query-transformation troubleshooting at beginner level"
---
# Rag Query Transformation — Beginner
