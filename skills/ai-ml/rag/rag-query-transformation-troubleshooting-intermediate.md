...
tags: ["rag","query-transformation","troubleshooting","intermediate"]
tools: ["claude-code","kilo","cline","opencode","cursor","windsurf"]
description: "rag query-transformation troubleshooting at intermediate level"
---
# Rag Query Transformation — Intermediate
