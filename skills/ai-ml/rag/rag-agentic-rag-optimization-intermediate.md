---
name: rag-agentic-rag-optimization
category: ai-ml/rag
version: 1.0.0
difficulty: intermediate
tags: ["rag","agentic-rag","optimization","intermediate"]
tools: ["claude-code","kilo","cline","opencode","cursor","windsurf"]
description: "rag agentic-rag optimization at intermediate level"
---
...
This skill covers optimization patterns for agentic-rag in rag.
...
```
// rag agentic-rag optimization pattern
