---
name: rag-ragas-evaluation-optimization
category: ai-ml/rag
version: 1.0.0
difficulty: intermediate
tags: ["rag","ragas-evaluation","optimization","intermediate"]
tools: ["claude-code","kilo","cline","opencode","cursor","windsurf"]
description: "rag ragas-evaluation optimization at intermediate level"
---
...
### Ragas Evaluation — optimization

This skill covers optimization patterns for ragas-evaluation in rag.
...
```
// rag ragas-evaluation optimization pattern
