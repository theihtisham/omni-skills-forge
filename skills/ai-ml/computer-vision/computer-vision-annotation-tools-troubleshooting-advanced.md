...
version: 1.0.0
difficulty: advanced
tags: ["computer-vision","annotation-tools","troubleshooting","advanced"]
tools: ["claude-code","kilo","cline","opencode","cursor","windsurf"]
description: "computer-vision annotation-tools troubleshooting at advanced level"
---
# Computer-vision Annotation Tools — Advanced
