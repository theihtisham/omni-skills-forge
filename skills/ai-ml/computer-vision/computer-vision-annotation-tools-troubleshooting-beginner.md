...
version: 1.0.0
difficulty: beginner
tags: ["computer-vision","annotation-tools","troubleshooting","beginner"]
tools: ["claude-code","kilo","cline","opencode","cursor","windsurf"]
description: "computer-vision annotation-tools troubleshooting at beginner level"
---
# Computer-vision Annotation Tools — Beginner
