...
version: 1.0.0
difficulty: beginner
tags: ["computer-vision","image-segmentation","troubleshooting","beginner"]
tools: ["claude-code","kilo","cline","opencode","cursor","windsurf"]
description: "computer-vision image-segmentation troubleshooting at beginner level"
---
# Computer-vision Image Segmentation — Beginner
