...
version: 1.0.0
difficulty: advanced
tags: ["agents","observability-agents","troubleshooting","advanced"]
tools: ["claude-code","kilo","cline","opencode","cursor","windsurf"]
description: "agents observability-agents troubleshooting at advanced level"
---
# Agents Observability Agents — Advanced
