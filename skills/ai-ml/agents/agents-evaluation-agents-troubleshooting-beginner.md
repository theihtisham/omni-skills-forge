...
version: 1.0.0
difficulty: beginner
tags: ["agents","evaluation-agents","troubleshooting","beginner"]
tools: ["claude-code","kilo","cline","opencode","cursor","windsurf"]
description: "agents evaluation-agents troubleshooting at beginner level"
---
# Agents Evaluation Agents — Beginner
