...
version: 1.0.0
difficulty: advanced
tags: ["agents","planning-decomposition","troubleshooting","advanced"]
tools: ["claude-code","kilo","cline","opencode","cursor","windsurf"]
description: "agents planning-decomposition troubleshooting at advanced level"
---
# Agents Planning Decomposition — Advanced
