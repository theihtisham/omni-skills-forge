...
version: 1.0.0
difficulty: beginner
tags: ["agents","autonomous-agents","fundamentals","beginner"]
tools: ["claude-code","kilo","cline","opencode","cursor","windsurf"]
description: "agents autonomous-agents fundamentals at beginner level"
---
# Agents Autonomous Agents — Beginner
