...
version: 1.0.0
difficulty: advanced
tags: ["agents","research-agents","troubleshooting","advanced"]
tools: ["claude-code","kilo","cline","opencode","cursor","windsurf"]
description: "agents research-agents troubleshooting at advanced level"
---
# Agents Research Agents — Advanced
