...
tags: ["agents","production-patterns","optimization","intermediate"]
tools: ["claude-code","kilo","cline","opencode","cursor","windsurf"]
description: "agents production-patterns optimization at intermediate level"
---
# Agents Production Patterns — Intermediate
