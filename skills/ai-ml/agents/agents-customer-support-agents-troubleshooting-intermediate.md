...
tags: ["agents","customer-support-agents","troubleshooting","intermediate"]
tools: ["claude-code","kilo","cline","opencode","cursor","windsurf"]
description: "agents customer-support-agents troubleshooting at intermediate level"
---
# Agents Customer Support Agents — Intermediate
