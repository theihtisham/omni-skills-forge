...
version: 1.0.0
difficulty: advanced
tags: ["agents","customer-support-agents","troubleshooting","advanced"]
tools: ["claude-code","kilo","cline","opencode","cursor","windsurf"]
description: "agents customer-support-agents troubleshooting at advanced level"
---
# Agents Customer Support Agents — Advanced
