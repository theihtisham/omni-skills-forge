...
version: 1.0.0
difficulty: beginner
tags: ["agents","observability-agents","troubleshooting","beginner"]
tools: ["claude-code","kilo","cline","opencode","cursor","windsurf"]
description: "agents observability-agents troubleshooting at beginner level"
---
# Agents Observability Agents — Beginner
