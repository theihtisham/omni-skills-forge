...
version: 1.0.0
difficulty: advanced
tags: ["agents","workflow-automation","troubleshooting","advanced"]
tools: ["claude-code","kilo","cline","opencode","cursor","windsurf"]
description: "agents workflow-automation troubleshooting at advanced level"
---
# Agents Workflow Automation — Advanced
