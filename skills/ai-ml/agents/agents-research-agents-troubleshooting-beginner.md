...
version: 1.0.0
difficulty: beginner
tags: ["agents","research-agents","troubleshooting","beginner"]
tools: ["claude-code","kilo","cline","opencode","cursor","windsurf"]
description: "agents research-agents troubleshooting at beginner level"
---
# Agents Research Agents — Beginner
