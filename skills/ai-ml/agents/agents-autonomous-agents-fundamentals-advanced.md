...
version: 1.0.0
difficulty: advanced
tags: ["agents","autonomous-agents","fundamentals","advanced"]
tools: ["claude-code","kilo","cline","opencode","cursor","windsurf"]
description: "agents autonomous-agents fundamentals at advanced level"
---
# Agents Autonomous Agents — Advanced
