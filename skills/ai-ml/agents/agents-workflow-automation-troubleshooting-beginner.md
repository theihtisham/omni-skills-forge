...
version: 1.0.0
difficulty: beginner
tags: ["agents","workflow-automation","troubleshooting","beginner"]
tools: ["claude-code","kilo","cline","opencode","cursor","windsurf"]
description: "agents workflow-automation troubleshooting at beginner level"
---
# Agents Workflow Automation — Beginner
