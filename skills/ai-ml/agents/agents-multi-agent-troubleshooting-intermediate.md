...
tags: ["agents","multi-agent","troubleshooting","intermediate"]
tools: ["claude-code","kilo","cline","opencode","cursor","windsurf"]
description: "agents multi-agent troubleshooting at intermediate level"
---
# Agents Multi Agent — Intermediate
