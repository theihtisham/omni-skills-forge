---
name: agents-error-recovery-best-practices
category: ai-ml/agents
version: 1.0.0
difficulty: intermediate
tags: ["agents","error-recovery","best-practices","intermediate"]
tools: ["claude-code","kilo","cline","opencode","cursor","windsurf"]
description: "agents error-recovery best-practices at intermediate level"
---
...
This skill covers best-practices patterns for error-recovery in agents.
...
```
// agents error-recovery best-practices pattern
