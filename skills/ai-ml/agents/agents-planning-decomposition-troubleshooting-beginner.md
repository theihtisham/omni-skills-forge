...
version: 1.0.0
difficulty: beginner
tags: ["agents","planning-decomposition","troubleshooting","beginner"]
tools: ["claude-code","kilo","cline","opencode","cursor","windsurf"]
description: "agents planning-decomposition troubleshooting at beginner level"
---
# Agents Planning Decomposition — Beginner
