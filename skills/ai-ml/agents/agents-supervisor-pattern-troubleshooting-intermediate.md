...
tags: ["agents","supervisor-pattern","troubleshooting","intermediate"]
tools: ["claude-code","kilo","cline","opencode","cursor","windsurf"]
description: "agents supervisor-pattern troubleshooting at intermediate level"
---
# Agents Supervisor Pattern — Intermediate
