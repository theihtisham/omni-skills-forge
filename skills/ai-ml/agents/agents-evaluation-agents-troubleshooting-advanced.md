...
version: 1.0.0
difficulty: advanced
tags: ["agents","evaluation-agents","troubleshooting","advanced"]
tools: ["claude-code","kilo","cline","opencode","cursor","windsurf"]
description: "agents evaluation-agents troubleshooting at advanced level"
---
# Agents Evaluation Agents — Advanced
