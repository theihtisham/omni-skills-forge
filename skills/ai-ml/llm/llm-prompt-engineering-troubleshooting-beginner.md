...
version: 1.0.0
difficulty: beginner
tags: ["llm","prompt-engineering","troubleshooting","beginner"]
tools: ["claude-code","kilo","cline","opencode","cursor","windsurf"]
description: "llm prompt-engineering troubleshooting at beginner level"
---
# Llm Prompt Engineering — Beginner
