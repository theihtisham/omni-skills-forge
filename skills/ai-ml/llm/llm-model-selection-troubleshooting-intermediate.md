...
tags: ["llm","model-selection","troubleshooting","intermediate"]
tools: ["claude-code","kilo","cline","opencode","cursor","windsurf"]
description: "llm model-selection troubleshooting at intermediate level"
---
# Llm Model Selection — Intermediate
