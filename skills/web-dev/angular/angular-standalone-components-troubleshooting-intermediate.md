...
tags: ["angular","standalone-components","troubleshooting","intermediate"]
tools: ["claude-code","kilo","cline","opencode","cursor","windsurf"]
description: "angular standalone-components troubleshooting at intermediate level"
---
# Angular Standalone Components — Intermediate
