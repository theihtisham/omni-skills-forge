...
version: 1.0.0
difficulty: expert
tags: ["nextjs","app-router","performance","expert"]
tools: ["claude-code","kilo","cline","opencode","cursor","windsurf"]
description: "nextjs app-router performance at expert level"
---
...
This skill covers performance patterns for app-router in nextjs.
...
```
// nextjs app-router performance pattern
