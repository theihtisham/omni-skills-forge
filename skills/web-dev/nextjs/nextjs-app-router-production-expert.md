...
version: 1.0.0
difficulty: expert
tags: ["nextjs","app-router","production","expert"]
tools: ["claude-code","kilo","cline","opencode","cursor","windsurf"]
description: "nextjs app-router production at expert level"
---
...
This skill covers production patterns for app-router in nextjs.
...
```
// nextjs app-router production pattern
