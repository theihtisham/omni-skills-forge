---
name: remix-resource-routes-migration
category: web-dev/remix
version: 1.0.0
difficulty: intermediate
tags: ["remix","resource-routes","migration","intermediate"]
tools: ["claude-code","kilo","cline","opencode","cursor","windsurf"]
description: "remix resource-routes migration at intermediate level"
---
...
### Resource Routes — migration

This skill covers migration patterns for resource-routes in remix.
...
```
// remix resource-routes migration pattern
