---
name: astro-islands-architecture-optimization
category: web-dev/astro
version: 1.0.0
difficulty: intermediate
tags: ["astro","islands-architecture","optimization","intermediate"]
tools: ["claude-code","kilo","cline","opencode","cursor","windsurf"]
description: "astro islands-architecture optimization at intermediate level"
---
...
This skill covers optimization patterns for islands-architecture in astro.
...
```
// astro islands-architecture optimization pattern
