---
name: astro-content-collections-architecture
category: web-dev/astro
version: 1.0.0
difficulty: intermediate
tags: ["astro","content-collections","architecture","intermediate"]
tools: ["claude-code","kilo","cline","opencode","cursor","windsurf"]
description: "astro content-collections architecture at intermediate level"
---
...
This skill covers architecture patterns for content-collections in astro.
...
```
// astro content-collections architecture pattern
