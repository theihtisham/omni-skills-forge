---
name: astro-images-patterns
category: web-dev/astro
version: 1.0.0
difficulty: intermediate
tags: ["astro","images","patterns","intermediate"]
tools: ["claude-code","kilo","cline","opencode","cursor","windsurf"]
description: "astro images patterns at intermediate level"
---
...
This skill covers patterns patterns for images in astro.
