...
version: 1.0.0
difficulty: advanced
tags: ["react","state-architecture","troubleshooting","advanced"]
tools: ["claude-code","kilo","cline","opencode","cursor","windsurf"]
description: "react state-architecture troubleshooting at advanced level"
---
# React State Architecture — Advanced
