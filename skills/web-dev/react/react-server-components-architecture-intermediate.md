...
tags: ["react","server-components","architecture","intermediate"]
tools: ["claude-code","kilo","cline","opencode","cursor","windsurf"]
description: "react server-components architecture at intermediate level"
---
...
This skill covers architecture patterns for server-components in react.
...
```
// react server-components architecture pattern
