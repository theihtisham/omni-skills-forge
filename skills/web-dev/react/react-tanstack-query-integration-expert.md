...
version: 1.0.0
difficulty: expert
tags: ["react","tanstack-query","integration","expert"]
tools: ["claude-code","kilo","cline","opencode","cursor","windsurf"]
description: "react tanstack-query integration at expert level"
---
...
This skill covers integration patterns for tanstack-query in react.
